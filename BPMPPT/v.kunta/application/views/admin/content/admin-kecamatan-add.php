<div class="page-content">
    ...
    <form action="" method="post" role="form" class="col-md-6">
        <div class="form-group">
            ...
            <input type="text" class="form-control" readonly="readonly" value="<?php echo $kab['nama_provinsi'] ?>" />
        </div>
        <div class="form-group">
            <label for="in_tmt">Nama Kabupaten</label>
            <input type="text" class="form-control" readonly="readonly" value="<?php echo $kab['nama_kabupaten'] ?>" />
        </div>
        <div class="form-group">
            <label for="in_tmt">Nama Kecamatan</label>
            <input type="text" class="form-control" name="nama_kecamatan" value="<?php echo $post['nama_kecamatan'] ?>" />
        </div>
        <div class="form-group">
