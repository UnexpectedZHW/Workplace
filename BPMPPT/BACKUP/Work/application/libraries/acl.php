...
class Acl
{
    ...
    function getPermKeyFromID($permID) {
        ...
        $sql = $this->ci->db->get('_perm_data',1);
        $data = $sql->result();
    ...
    function getUserRoles() {
        ...
        $sql = $this->ci->db->get('_user_roles');
        $data = $sql->result();
    ...
    function getRolePerms($role) {
        ...
        $sql = $this->ci->db->get('_role_perms'); //$this->db->select($roleSQL);
        $data = $sql->result();
        $perms = array();
        foreach( $data as $row )
        {
    ...
    function getUserPerms($userID) {
        ...
        $this->ci->db->order_by('addDate','asc');
        $sql = $this->ci->db->get('_user_perms');
        $data = $sql->result();
